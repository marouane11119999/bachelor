...
class Dataset:
    ...
    def __init__(self,
        ...
        openml_dataset_ids = ["725", "310", "1046", "823", "137", "42493", "4135", "251", "151", "40922", "40498", "30",
                              "1459", "1481", "184", "375", "32", "41027", "6", "40685", "43572"]
        ...
        if dataset_name in baran_dataset_ids:
            self.path = f"../datasets/{dataset_name}/dirty_c.csv"
            ...
            if dataset_name == 'food':
                ...
                self.typed_dataframe = self.read_csv_dataset(self.path)
    ...
    def get_data_quality(self):
        ...
        """
        return 1.0 - float(len(self._get_actual_errors_dictionary_ground_truth())) / (
